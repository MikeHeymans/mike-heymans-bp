	...
	Indien dit niet het geval is, wordt de operatie niet uitgevoerd en kan het systeem op een gepaste manier reageren. Deze manier van transactiebeheer noemt men \textquotedbl optimistic locking \textquotedbl{}.
